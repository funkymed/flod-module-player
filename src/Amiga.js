...
import { CoreMixer, CorePlayer } from "./Core";

export function AmigaChannel(idx) {
  ...
  return Object.create(null, {
    ...
    process: {
      value: function (model, sample) {
        var FL = 0.52133458435322,
          P0 = 0.4860348337215757,
          P1 = 0.9314955486749749,
          d = 1.0 - P0;
  ...
  Object.defineProperties(o, {
    ...
    store: {
      value: function (stream, len, pointer) {
        ...
        for (len += add; i < len; ++i) this.memory[i] = 0.0;
...
export function AmigaPlayer(mixer) {
  var o = CorePlayer();
