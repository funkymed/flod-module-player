            ...
            for (i = mixPos; i < mixLen; ++i) {
              ...
              if (!chan.mixCounter) {
                ...
                if (s2) {
                  ...
                  mixValue +=
                    (d2[chan.oldPointer + chan.oldDir] - mixValue) *
                    chan.oldFraction;
                  ...
                  sample.l +=
                    value * chan.lmixRampU + mixValue * chan.lmixRampD;
                  sample.r +=
                    value * chan.rmixRampU + mixValue * chan.rmixRampD;
...
export function SBPlayer(mixer) {
  var o = CorePlayer();
